...
<style>
  ...
  /* ============================================================
     HERO & WORKSPACE SELECTOR (STRICT CENTERING)
     ============================================================ */
  ...
  /* HIDE THE NATIVE RADIO CIRCLE COMPLETELY (CSS3 Universal Inversion) */
  ...
  /* Ensure text container remains legible */
...
# Symmetrically centered within the layout grid
_, col_w_center, _ = st.columns([1, 2, 1])
with col_w_center:
...
with tab_us:
    render_market_dashboard("US", "USD", us_buys, active_table, entity_prefix, is_meraki)  div[data-testid="stRadio"] {
    display: flex !important;
    flex-direction: column !important;
    align-items: center !important;
    justify-content: center !important;
  ...
  /* Hide ONLY the radio circle indicator without breaking the text container */
  div[data-testid="stRadio"] div[role="radiogroup"] label > div:not(:has([data-testid="stMarkdownContainer"])):not([data-testid="stMarkdownContainer"]) {
    display: none !important;
    width: 0 !important;
    height: 0 !important;
    margin: 0 !important;
  ...
  /* Force Option Label & Text to be fully visible */
  div[data-testid="stRadio"] div[role="radiogroup"] label [data-testid="stMarkdownContainer"] {
    display: flex !important;
    align-items: center !important;
    justify-content: center !important;
...
# Centered naturally across the viewport
entity_choice = st.radio(
    "Workspace Selector",
    ["👤 Personal Portfolio", "🏛️ Meraki Mahardika Investama"],
    horizontal=True,
